          ...
          {plans.map((plan, i) => (
            <div
              ...
              className={`
                ...
                ${
                  plan.highlighted
                    ? "bg-gradient-to-b from-[#111827] to-[#0B0F19] border-purple-500 scale-[1.03] shadow-xl shadow-purple-500/10"
            ...
            >
              ...
              {/* badge */}
              {plan.highlighted && (
                <div className="absolute top-5 right-5 text-xs px-3 py-1 rounded-full bg-purple-500/20 text-purple-300 border border-purple-500/30">
                  Best Choice
                </div>
              )}
...
>
  Get Started
        ...
        <div className="text-center mt-12 text-gray-500 text-sm">
          {/* Cancel anytime • No hidden fees • Built for focus */}
          Built for focus
        </div>
      </div>
    </section>
